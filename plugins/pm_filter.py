    ...
    # Thank you AMROBOTS for helping us in this Journey
import asyncio
import re
import ast
import math
...
# Born to make history @AMROBOTS_BOTS !
...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://telegram.me/AMROBOTS_BOTS')
        ] 
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Love @AM_ROBOTS ♥️')
            else:
                await query.message.edit_text(
                    "I'm not connected to any groups!\nCheck /connections or connect to any groups",
                    quote=True
                )
                return await query.answer('♥️ Thank You 𝒜𝑀𝑅𝒪𝐵𝒪𝒯𝒮 ♥️')
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔔 Updates 🤖', url='https://t.me/AMROBOTS_BOTS')
        ], [
            InlineKeyboardButton('🙆🏻 Help 🦾', callback_data='help'),
            InlineKeyboardButton('♥️ About ♥️', callback_data='about')
        ],[
            InlineKeyboardButton('Watch Tutorial', url='https://apnatube.in/@apnatube')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        await query.answer('♥️ Thank You 𝒜𝑀𝑅𝒪𝐵𝒪𝒯𝒮 ♥️')
        ...
        try:
            btn = [[
                ...
                InlineKeyboardButton(text=f"🐞 REPORT ISSUE 🐞", url=f"https://telegram.me/AmRobots_Support")
            ],[
                InlineKeyboardButton(text=f"⚡️ Learn Bot Making 🦋", url=f"https://apnatube.in/@apnatube")
    ...
    #     buttons = [
    #         [
    #         InlineKeyboardButton("D͢o͢n͢a͢t͢e͢ AmRobots", callback_data="thdonatelazydev"),
    #         ],
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ʜᴏᴡ 2 ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://telegram.me/AmRobots_Bots'),
        ] 
    )
    if offset != "":
